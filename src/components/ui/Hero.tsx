        ...
        <div className="relative bg-white overflow-hidden">
                    ...
                    <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                        <div className="sm:text-center lg:text-left">
                            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                                <span className="block xl:inline">Bienvenue sur KIRAEDES</span>{" "}
                                <span className="block text-blue-600 xl:inline">l'endroit où vous trouvez les appartements de vos rêves</span>
                            </h1>
                            <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-auto">
                                title: "Ajouter un bien | KIRAEDES",Découvrez une large sélection de maisons et d'appartements disponibles à la vente ou à la location. Trouvez votre futur chez-vous dès aujourd'hui.
                            </p>
            ...
            <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-gray-50">
                ...
                <div className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center text-gray-400 bg-gray-200">
                    <span className="text-xl">Image de fond ou 3D ici</span>
                </div>
            </div>
        </div>
    );
